...
#include "diago/module_base/module_device/types.h"

#include "py_dav_subspace.hpp"
...
PYBIND11_MODULE(_py_dav, m)
{
    m.doc() = "Python extension for eigensolver using davidson subspace method built with pybind11 and scikit-build.";
    bind_hsolver(m);
}